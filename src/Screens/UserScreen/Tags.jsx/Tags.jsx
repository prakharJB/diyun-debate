...
function Tags() {
  ...
  //     try {
  //       const url = "https://www.kialo.com/api/v1/discussiontags?timestamp=1701781747945&dfuipoldyz=gt045bfs";
        ...
        <Container>
          <Row>
            <Col className="bg text-center">
              <h2 className="text-center explore-page__headline">{tHn.explore_debates}</h2>
            </Col>
          </Row>
        </Container>
      </section>
                    ...
                    {/* {items?.map((val, index) => (
                      <li className="mt-4">
                        ...
                        >
                          ...
                          <div className="tag-card__name">{val.tagName}</div>
                        </Link>
                      </li>
                    ))} */}
                    <li className="mt-4">
                        <Link
                          to={`/explore/tags/Ethics`}
                          className="tag-card"
                        >
                          <img
                            src={ethics}
